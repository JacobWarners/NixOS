...

{
  ...
  boot.initrd.luks.devices."crypted-root".device = "/dev/disk/by-uuid/6cb1713b-252a-435f-8c5c-d4b404e9db96";
  ...
  # networking.interfaces.enp105s0u1.useDHCP = lib.mkDefault true;

...
in {
  ...
  # This section uses the function you wanted to download and set the theme.
  home.pointerCursor =
    let
      getFrom = url: hash: name: {
        ...
        package =
          pkgs.runCommand name {} ''
            THEME_DIR=${pkgs.fetchzip {
              url = url;
              hash = hash;
            }}
            mkdir -p $out/share/icons
            cp -r $THEME_DIR/* $out/share/icons/${name}
          '';
      };
    in
      getFrom
        # This is the direct URL to the pre-compiled release file
        "https://github.com/ful1e5/Bibata_Cursor/releases/download/v2.0.6/Bibata-Modern-Classic.tar.xz"
        # This is the correct hash for the file above
